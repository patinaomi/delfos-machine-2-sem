...
const CadastrarDadosPessoaisClienteScreen: React.FC<{ navigation: any }> = ({ navigation }) => {
    ...
    <ScrollView contentContainerStyle={styles.container}>
      <Text style={styles.title}>Meus Dados</Text>
        ...
        <View style={styles.section}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate("CadastrarEnderecoResidenciaCliente")} style={styles.nextButton}>
...
export default CadastrarDadosPessoaisClienteScreen;
